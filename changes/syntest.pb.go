...
type SynTestConfig struct {
	...
	Timeouts             *Timeouts         `protobuf:"bytes,11,opt,name=timeouts,proto3" json:"timeouts,omitempty"`
	PluginRestartPolicy  string            `protobuf:"bytes,12,opt,name=pluginRestartPolicy,proto3" json:"pluginRestartPolicy,omitempty"`
	LogWaitTime          string            `protobuf:"bytes,13,opt,name=logWaitTime,proto3" json:"logWaitTime,omitempty"`
	Config               string            `protobuf:"bytes,14,opt,name=config,proto3" json:"config,omitempty"`
	Etc                  map[string]string `protobuf:"bytes,15,rep,name=etc,proto3" json:"etc,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *SynTestConfig) GetLabelSelector() string {
	if m != nil {
...
var fileDescriptor_7284b2a0aa7b4fec = []byte{
	...
	,
}
